...
public class ShortcutUtils {
    ...
    public static final KeyCodeCombination DETAILS_KEY = new KeyCodeCombination(KeyCode.D, KeyCombination.CONTROL_DOWN);
    ...
    public static final KeyCodeCombination LOCATION_KEY = new KeyCodeCombination(KeyCode.L, KeyCombination.CONTROL_DOWN);
    public static final KeyCodeCombination EXPORT_KEY = new KeyCodeCombination(KeyCode.O, KeyCombination.CONTROL_DOWN);
